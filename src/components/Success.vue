<script setup lang="ts">
    ...
    import BeTheCoin from '../assets/svg/BeTheCoin.svg?url'
    import boss from  '../assets/svg/boss.svg?url'
    import fifoooo from  '../assets/svg/fifoooo.svg?url'
    import kira from  '../assets/svg/kira.svg?url'
